# TK-002: UI y diseño de la pantalla de Proyectos
...
Aplicar el sistema de diseño `DESIGN.md` (tema "Precision Focus": colores, tipografía, radios y espaciado) a los componentes ya funcionales de la pantalla de Proyectos ([TK-001](TK-001-crear-editar-y-listar-proyectos.md)), verificar su fidelidad visual frente al prototipo de alta fidelidad en Figma, y confirmar que la navegación lateral hacia Proyectos (ya provista por US-000) queda accesible desde cualquier otra sección.

## Dependencias

- [TK-001: Crear, editar y listar Proyectos](TK-001-crear-editar-y-listar-proyectos.md) — componentes funcionales (`project-modal.tsx`, `project-card.tsx`, `projects-list.tsx`, `src/app/proyectos/page.tsx`) sobre los que se aplica esta tarea; TK-002 no agrega comportamiento nuevo, solo estilo y verificación visual.
- [TK-002: Layout, navegación, tema de Tailwind y rutas placeholder (US-000)](../US-000-fundamentos/TK-002-layout-navegacion-y-rutas-placeholder.md) — `AppShell` + `SidebarNav` ya implementan la navegación lateral con el enlace a `/proyectos` (AC-008); esta tarea no modifica ese módulo compartido, solo verifica el resultado (TC-014). Los tokens Tailwind (`@theme` en `src/app/globals.css`) del tema "Precision Focus" ya quedan definidos ahí (IT-01 de ese TK); esta tarea los consume, no los redefine.

## Referencias

- **Arquitectura:** [ADR-002: Uso de Tailwind CSS](../../../adr/ADR-002-uso-de-tailwind-css.md) (los tokens de tema se centralizan en [US-000 TK-002](../US-000-fundamentos/TK-002-layout-navegacion-y-rutas-placeholder.md)), [ADR-003: Uso de Base UI](../../../adr/ADR-003-uso-de-base-ui.md), [ADR-005: Arquitectura feature-based](../../../adr/ADR-005-arquitectura-feature-based.md).
