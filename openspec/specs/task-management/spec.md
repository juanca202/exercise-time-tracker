...
Gestionar el ciclo de vida completo de una Tarea dentro del dominio de Time Tracker: la unidad de trabajo asociada obligatoriamente a un Proyecto sobre la que se registra tiempo (vía temporizador o entrada manual). Cubre la creación, edición (incluyendo reasignación de Proyecto), eliminación (con regla de bloqueo cuando existen Registros de Tiempo asociados) y visualización de Tareas, con persistencia local del dispositivo.
