...
Ofrecer visibilidad sobre el tiempo invertido en el dominio de Time Tracker: el historial navegable de Registros de Tiempo generados por el temporizador y el ingreso manual, los totales de tiempo acumulado agregados por Tarea, Proyecto y mes, y el indicador de avance hacia una meta semanal fija de 40 horas en el panel principal de Tareas. Sin esta capability, los Registros de Tiempo quedarían atrapados sin utilidad para el usuario. Depende de los Registros de Tiempo (`task-management`, `timer-tracking`, `manual-time-entry`) y de los Proyectos (`project-management`) como fuente de datos, sin modificar sus requisitos.
