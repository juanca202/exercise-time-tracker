...
El sistema SHALL mostrar en la pantalla "Proyectos" el listado de Proyectos existentes con su Nombre y Descripción, y ofrecer acciones para editar y eliminar cada uno.
